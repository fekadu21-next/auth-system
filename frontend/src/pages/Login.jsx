            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-lg">
                <button
                  ...
                  className={`px-2.5 py-0.5 rounded-md text-xs font-bold transition-all duration-300 ${
                    activeTab === "editor"
                ...
                <button
                  ...
                  className={`px-2.5 py-0.5 rounded-md text-xs font-bold transition-all duration-300 flex items-center gap-1 ${
                    activeTab === "history"
                      ? "bg-white text-blue-600 shadow-xs scale-105"
                      : "text-slate-500 hover:text-slate-800"
                  }`}
